...
class _$TodoModelImpl implements _TodoModel {
  const _$TodoModelImpl(
      ...
      @HiveField(5) required this.ownerId});
  ...
  @override
  String toString() {
    return 'TodoModel(id: $id, title: $title, description: $description, completed: $completed, createdAt: $createdAt, ownerId: $ownerId)';
  }
...
abstract class _TodoModel implements TodoModel {
  const factory _TodoModel(
      ...
      @HiveField(5) required final String ownerId}) = _$TodoModelImpl;
